...
public class SampleAPITests {
	...
	public void getOneEmployee() {
		...
		Response response = RestAssured.given().param("employee_id", "4355").contentType("application/json").header(
				"Authorization",
				"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1ODI2NTAxODMsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTU4Mjc2NTM4MywidXNlcklkIjoiMjc3In0.K4VfnReOIRsW2Wcflt8TnjpP9l9U_rvP6Uza91jm8B4")
				.when().get("http://http://54.167.125.15/syntaxapi/api/getOneEmployee.php");
	...
	public void getALLEmployeeStatuses() {
		...
		Response response = RestAssured.given().contentType("application/json").header("Authorization",
				"Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1ODI2NTAxODMsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTU4Mjc2NTM4MywidXNlcklkIjoiMjc3In0.K4VfnReOIRsW2Wcflt8TnjpP9l9U_rvP6Uza91jm8B4")
				.when().get("http://http://54.167.125.15/syntaxapi/api/employeeStatus.php");
		response.prettyPrint();
	...
	public void createEmployee() {
		...
		.contentType("application/json")
				.when().post("http://http://54.167.125.15/syntaxapi/api/createEmployee.php");
